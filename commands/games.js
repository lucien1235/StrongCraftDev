...
module.exports.run = async (bot, message, args) => {
    ...
    const gamesembed = new Discord.RichEmbed()
        ...
        .addField(prefix + "approved", `Get an approved picture of a certain player.\nUsage: **${prefix}approved <@user>**`)
        .addField(prefix + "wanted", `Get an wanted picture of a certain player.\nUsage: **${prefix}wanted <@user>**`)
